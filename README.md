...
<p align="center">
  ...
  <h3 align="center">2D Transformations</h3>
...
This is a python project which uses NumPy and Matplotlib to do various transformations on 2-Dimensional Shapes and then plot them!
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-2D-Transformations.git
   ```
- Python Modules
  - `pip install numpy` 
